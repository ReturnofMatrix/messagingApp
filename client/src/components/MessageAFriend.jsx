                    ...
                    <div className="flex items-end space-x-2 max-w-xs">
                      ...
                      <div 
                        className={`px-4 py-3 rounded-2xl shadow-lg text-base leading-relaxed transition-all duration-300 group-hover:shadow-xl ${
                          isMine 
                            ? 'bg-gradient-to-r from-orange-300 to-orange-400 text-gray-900 font-medium rounded-bl-sm'
                            : isDarkMode
                              ? 'bg-gray-700 text-orange-100 border-2 border-orange-200 rounded-br-sm hover:bg-gray-600'
                              : 'bg-orange-50 text-orange-900 border-2 border-orange-300 rounded-br-sm hover:bg-orange-100'
                        }`}
                      >
                        {message.text}
                      </div>
